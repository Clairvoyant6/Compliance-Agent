    ...
    <div className="p-5 lg:p-7 space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => alert("Sync Portal is running in simulated sandbox mode. All local transactions are fully synced with GSTN.")}
          ...
          <button
            onClick={() => alert("GST Return filing simulated. Draft return generated and validated successfully for this period.")}
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-opacity hover:opacity-80"
            style={{ background: 'var(--iq-accent-bg)', color: 'var(--iq-accent)', border: '1px solid var(--iq-border)' }}
          >
